...
public class RecordSubscriber extends Subscriber {
  ...
  public static void writePacketToCSV(
      BufferedWriter writer, Packet packet, double timestamp, int lineBreak) throws IOException {
  ...
  public void accept(Packet packet) {
    ...
    // OutputStreamWriter(context.getContentResolver().openOutputStream(location, "wa")))) {
